...
class SAC:
    ''' 处理离散动作的SAC算法 '''
    def __init__(self, state_dim, hidden_dim, action_dim, actor_lr, critic_lr, alpha, alpha_lr, target_entropy, tau, gamma, device):
        # 初始化网络结构
    ...
    def calc_target(self, rewards, next_states, dones):
        ...
        entropy = -torch.sum(next_probs * next_log_probs, dim=1, keepdim=True) # 策略熵
    ...
    def update(self, transition_dict, writer, learn_step):
        # S,A,R,S',D数据结构处理
        ...
        writer.add_scalar('train/critic_1_loss', critic_1_loss, learn_step)
        writer.add_scalar('train/critic_2_loss', critic_2_loss, learn_step)
        ...
        writer.add_scalar('train/actor_loss', actor_loss, learn_step)
        ...
        writer.add_scalar('train/alpha_loss', alpha_loss, learn_step)
        writer.add_scalar('train/target_entropy', self.target_entropy, learn_step)
    ...
    def load(self, path):
        ...
        critic_1_path = f'{path}/critic_1'
        critic_2_path = f'{path}/critic_2'
